#!/usr/bin/env bash
#
# Builds a clean kntnt-modal-mega-menu-ollie.zip containing only runtime
# files.
#
...
REPO="Kntnt/kntnt-modal-mega-menu-ollie"
PLUGIN_DIR="kntnt-modal-mega-menu-ollie"
...
KEEP=(
	...
	css
	js
	kntnt-modal-mega-menu-ollie.php
	languages
	LICENSE
	README.md
)
